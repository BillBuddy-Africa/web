...
?>
        ...
        <div class="banner-style position-relative overflow-hidden" style="background-image: url(assets/images/Products-img.jpg)">
            <div class="container">
                <div class="page-banner-content">
                    <h1 class="text-white">Our Products</h1>
                    <p class="text-white lead">We’re your trusted partner for fast, secure, <br>and reliable digital transactions.</p>
                </div>
            </div>
        </div>
