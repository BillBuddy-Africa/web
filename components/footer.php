                    ...
                    <div class="col-xl-4 col-lg-9 col-md-6">
                        <div class="footer-weight">
                            <a class="navbar-brand logo-brand p-0 mb-3" href="./">
                                <img src="assets/images/bb_logo_light.svg" width="300" alt="image">
                            </a>
                            ...
                            <ul class="social">
                                ...
                                <li>
                                    <a href="https://www.facebook.com/billbuddyhq" target="_blank">
                                        <i class="ri-facebook-fill"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.twitter.com/billbuddyhq" target="_blank">
                                        <i class="ri-twitter-x-line"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/billbuddyhq" target="_blank">
