        <div class="footer-area bg-color-000000 pt-120">
            <div class="container">
                <div class="row" data-cues="slideInUp" data-duration="800">
                    <div class="col-xl-4 col-lg-9 col-md-6">
                        <div class="footer-weight">
                            <a class="navbar-brand logo-brand p-0 mb-3" href="./">
                                <img src="assets/images/mixed_bb_logo_light.svg" width="300" alt="image">
                            </a>
                            <p class="text-white mt-3 mb-3">Simplify your financial life today with fast, secure, and smart transactions. Download now and take control of your money, from everyday bills to digital assets!</p>
                            <ul class="social">
                                <li><span>Follow Us:</span></li>
                                <li>
                                    <a href="https://www.facebook.com/usebillbuddy" target="_blank">
                                        <i class="ri-facebook-fill"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.twitter.com/usebillbuddy" target="_blank">
                                        <i class="ri-twitter-x-line"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/usebillbuddy" target="_blank">
        ...
        <div class="copyright-area bg-color-000000">
            <div class="container">
                <div class="copyright-border">
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-6 col-md-6 mx-auto text-center">
                            <p>© <script>document.write(new Date().getFullYear());</script> Billbuddy. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            _smartsupp.key = 'f072765a307be315b293381b17a110f7214435c5';
